...
public class DeleteShiftTemplateRequestValidatorTests
{
    private UnitOfWorkFactory _dbFactory;
    private IUnitOfWork _unitOfWorkSqlite;
    private DeleteShiftTemplateRequestValidator _validator;
    ...
    public void SetUp()
    {
        ...
        _validator = new DeleteShiftTemplateRequestValidator(_unitOfWorkSqlite);
    }
    ...
    {
        // Arrange
        var request = new DeleteShiftTemplateRequest(Guid.NewGuid());
    ...
    public async Task Should_Not_Have_Error_When_ShiftTemplate_Exists()
    {
        ...
        var request = new DeleteShiftTemplateRequest(template.Id);
